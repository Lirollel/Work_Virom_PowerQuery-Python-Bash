...
del_list = ['D67del', 'S68del', 'T69del', 'K70del']
ins_list = ['T69ins']

with open ('records\mutations_DS\just_mut.json', 'r') as file:
    data = json.load(file)
    ...
    for sequence in keys_list:
        ...
        RT_lst_for_nums = [drug_mut_RT, mut_list_RT, RT_random_mutations]
        ...
        x = 2
        while x == 2:
            RT_m_pos = random.sample (range(1,100), 15)
            ...
            for dct in RT_lst_for_nums:
                ...
                for num in RT_m_pos:
                    ...
                    for m in dct.keys():
                        ...
                        if ran_drug_mut_RT != {} and ran_mut_list_RT != {} and R_random_mutations_RT != {}:
                            x +=1
                        elif ran_drug_mut_RT == {} or ran_mut_list_RT == {} or R_random_mutations_RT == {}:
                            continue

        # # Удаление поворений
        # turn = [ran_drug_mut_PR, ran_mut_list_PR, R_random_mutations_PR, ran_drug_mut_RT, ran_mut_list_RT, R_random_mutations_RT]
        # for dct in turn:
        #     for key in list(dct.keys()):
...
with open ('records\mutations_DS\just_mut.json', 'w') as load_file:
        load_file.write(new)
print('DONE')
